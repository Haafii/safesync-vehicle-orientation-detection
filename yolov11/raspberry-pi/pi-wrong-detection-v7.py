...
result_color = (0, 255, 0)  # Default to green (Not Wrong Side)
...
while True:
    ...
    cv2.putText(frame, f"Back: {left_back_count}", (10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
    cv2.putText(frame, f"Side: {left_side_count}", (10, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)
    cv2.putText(frame, f"Front: {left_front_count}", (10, 130), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 255), 2)

    cv2.putText(frame, f"Back: {right_back_count}", (half_width + 10, 70), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 255), 2)
    cv2.putText(frame, f"Side: {right_side_count}", (half_width + 10, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 255), 2)
    cv2.putText(frame, f"Front: {right_front_count}", (half_width + 10, 130), cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 0, 255), 2)

    # Display accumulated counts for the left half at the bottom-left corner
    cv2.putText(frame, f"Accum Back: {left_accum_back}", (10, frame.shape[0] - 90), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 150), 2)
    cv2.putText(frame, f"Accum Side: {left_accum_side}", (10, frame.shape[0] - 60), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 150), 2)
    cv2.putText(frame, f"Accum Front: {left_accum_front}", (10, frame.shape[0] - 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 150), 2)

    # Display the result message at the bottom-middle with the appropriate color
    cv2.putText(frame, result_message, (frame_width // 2 - 150, frame.shape[0] - 30), cv2.FONT_HERSHEY_SIMPLEX, 1, result_color, 2)
